...
from BorrarPantalla import Borro  # Desde la aplicación BorrarPantalla importo la funcion. 
from leer_registro import leer_registros
...
def leer_registros(): 
    ...
    if not datos: 
        ...
        return 
    for r in datos: 
        print(f"ID: {r['id']} | Empleado: {r['empleado']} | Nombre: {r.get('nombre', 'Sin nombre')} | Fecha: {r['fecha']} | Entrada: {r['entrada']} | Salida: {r['salida']} | Horas: {r['horas_trabajadas']}") 
